...
function SettingTab(props) {
    return (
        <div className="tab-pane fade height-100-p active show"
             id="setting"
             role="tabpanel">
                ...
                <form>
                    <ul className="profile-edit-list row">
                        <li className="weight-500 col-md-6">
                            <h4 className="text-blue h5 mb-20">Edit Your
                                Personal
                                Setting</h4>
                            ...
                            <div className="form-group">
                                ...
                                <div
                                    ...
                                    <select
                                        ...
                                        // dataStyle="btn-outline-secondary btn-lg"
                            ...
                            <div className="form-group">
                                <div
                                    ...
                                    <label
                                        className="custom-control-label weight-400"
                                        htmlFor="customCheck1-1">I agree to
                                        receive
