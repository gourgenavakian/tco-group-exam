                ...
                <div className="container pd-0">
                    ...
                    <div className="profile-task-list pb-30">
                        <ul>
                            <li>
                                ...
                                adipisicing
                                elit. Id ea earum.
                                <div className="task-assign">Assigned to
                                    Ferdinand
                    ...
                    <div
                        ...
                        <div id="mCSB_4"
                             ...
                             style={{maxHeight: '1072.88px'}} tabIndex="0">
                                                                                    ...
                                                                                    <li>
                                                                                        <a role="option"
                                                                                           ...
                                                                                           aria-selected="false"><span
                                                                                            className=" bs-ok-default check-mark"></span><span
                                                                                            className="text">Ferdinand M.</span></a>
                                                                                    </li>
                                                                                    <li>
                                                                                        <a role="option"
                                                                                           className="dropdown-item"
                                                                                           ...
                                                                                           aria-selected="false"><span
                                                                                            className=" bs-ok-default check-mark"></span><span
                                                                                            className="text">Don H. Rabon</span></a>
                                                                                    </li>
                                                                                    <li>
                                                                                        <a role="option"
                                                                                           className="dropdown-item"
                                                                                           ...
                                                                                           aria-selected="false"><span
                                                                                            className=" bs-ok-default check-mark"></span><span
                                                                                            className="text">Ann P. Harris</span></a>
                                                                                    </li>
                                                                                    <li>
                                                                                        <a role="option"
                                                                                           className="dropdown-item"
                                                                                           ...
                                                                                           aria-selected="false"><span
                                                                                            className=" bs-ok-default check-mark"></span><span
                                                                                            className="text">Katie D. Verdin</span></a>
                                                                                    </li>
                                                                                    <li>
                                                                                        <a role="option"
                                                                                           className="dropdown-item"
                                                                                           ...
                                                                                           aria-selected="false"><span
                                                                                            className=" bs-ok-default check-mark"></span><span
                                                                                            className="text">Christopher S. Fulghum</span></a>
                                                                                    </li>
                                                                                    <li>
                                                                                        <a role="option"
                                                                                           className="dropdown-item"
                                                                                           ...
                                                                                           aria-selected="false"><span
                                                                                            className=" bs-ok-default check-mark"></span><span
                                                                                            className="text">Matthew C. Porter</span></a>
                                                                                    </li>
                                                                                </ul>
                                                                            </div>
                                                                        </div>
